# services/Model_ETF/etf_advisor_engine.py
...
# Fix path so we can import database if needed later
...
def get_recommendation(amount: float, specific_date: str = None):
    ...
    return {
        ...
        "allocations": alloc[['ETF', 'forecast_2y', 'Weight', 'Amount_EUR', 'reason']].to_dict(orient='records')
    }